...
const RestaurantSearch = ({toHide}: RestaurantSearchProps) => {
  const userSearch = useSelector((state: FBRootState) => state.restaurant.newFilters.search);
  ...
  const filterRestaurant = (userInputQuery: string) => {
    ...
    dispatch(restaurantUpdateFiltersAction({filterCategory:'search', filterCategoryProperty: 'searchTerm', newValue: searchQueryRegex}));
    dispatch(restaurantUpdateFiltersAction({filterCategory:'search', filterCategoryProperty: 'userInput', newValue: userInputQuery}));
  };
    ...
    <View style={styles.mainWrapper}>
      <View
        ...
        <Autocomplete
          ...
          value={userInput}
          onChangeText={userInput => filterRestaurant(userInput)}
          flatListProps={{
            ...
            renderItem: (item: ListRenderItemInfo<RestaurantHomeListItem> ) => (
              <TouchableOpacity
                onPress={() => {
                  ...
                  dispatch(restaurantUpdateFiltersAction({filterCategory:'search', filterCategoryProperty: 'searchTerm', newValue: item.item.name}));
                  dispatch(restaurantUpdateFiltersAction({filterCategory:'search', filterCategoryProperty: 'userInput', newValue: item.item.name}));
                }}>
